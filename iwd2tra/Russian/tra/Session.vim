...
silent only
silent tabonly
cd ~/source/translations/iwd2_rus/iwd2tra/Russian/tra
...
argglobal
if bufexists("rec_utf8.tra") | buffer rec_utf8.tra | else | edit rec_utf8.tra | endif
balt _
setlocal keymap=
setlocal noarabic
...
silent! normal! zE
let &fdl = &fdl
let s:l = 66531 - ((13 * winheight(0) + 14) / 28)
...
wincmd w
argglobal
if bufexists("_") | buffer _ | else | edit _ | endif
balt rec_utf8.tra
setlocal keymap=
setlocal noarabic
setlocal noautoindent
...
silent! normal! zE
let &fdl = &fdl
let s:l = 34202 - ((14 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 34202
