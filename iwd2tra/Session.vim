...
silent only
silent tabonly
cd ~/source/translations/iwd2_rus/iwd2tra
...
silent! normal! zE
let &fdl = &fdl
let s:l = 40179 - ((13 * winheight(0) + 14) / 28)
...
wincmd w
argglobal
if bufexists("English/tra/rec.tra") | buffer English/tra/rec.tra | else | edit English/tra/rec.tra | endif
balt Russian/tra/rec_utf8.tra
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
silent! normal! zE
let &fdl = &fdl
let s:l = 39799 - ((12 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 39799
...
exe '2resize ' . ((&lines * 27 + 29) / 58)
tabnext 1
badd +1 Russian/tra/rec_utf8.tra
