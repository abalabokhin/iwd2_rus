...
2.6 от 03.10.2025:
- исправлен перевод пивафви (был пивафи), благодаря CblblP
- Различные исправления от Станислава
- Изменено техническое оформление для совместимости с IWD2EE: было "Класс защиты: +X (тип)", стало "Класс защиты (тип): +X"
